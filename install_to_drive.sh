...
# >>> UUID-based Self-Awareness
# Search for the UniversalBoot partition by UUID
insmod ext2
search --no-floppy --fs-uuid --set=root b14a98fb-d01b-45ea-8189-901007182491

# >>> Dynamic Configuration
# Load the dynamic configuration file generated by the Universal Wrapper.
if [ -f /grub_dynamic.cfg ]; then
    source /grub_dynamic.cfg
fi
